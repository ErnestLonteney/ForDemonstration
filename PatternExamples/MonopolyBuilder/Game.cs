...
namespace MonopolyFactory
{
    internal class Game
    {
        ...
        public Game(MonopolyBoardBuilder monopolyBuilder)
        {
            var deck1 = monopolyBuilder.CreateDeck1();
            var deck2 = monopolyBuilder.CreateDeck2();

            _board = monopolyBuilder.BuildBoard(deck1, deck2);  
        }
